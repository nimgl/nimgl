...
{.passC: "-DGLEW_NO_GLU -DGLEW_BUILD -DGLEW_STATIC -I" &
  currentSourcePath().splitPath.head & "/private/glew/include -I" &
  currentSourcePath().splitPath.head & "/private/glew/include/GL".}
