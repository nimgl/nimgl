...
type
  ...
  ImFont* {.importc: "ImFont", header: "<cimgui.h>".} = object
    ...
    indexLookup* {.importc: "IndexLookup".} : ImVector_unsigned_short
  ...
  ImVec4* {.importc: "ImVec4", header: "<cimgui.h>".} = object
    ...
    z* {.importc: "z".} : float32
    w* {.importc: "w".} : float32
  GlyphRangesBuilder* {.importc: "GlyphRangesBuilder", header: "<cimgui.h>".} = object
    usedChars* {.importc: "UsedChars".} : ImVector_unsigned_char
  ...
  ImGuiIO* {.importc: "ImGuiIO", header: "<cimgui.h>".} = object
    ...
    configResizeWindowsFromEdges* {.importc: "ConfigResizeWindowsFromEdges".} : bool
    ...
    inputCharacters* {.importc: "InputCharacters".} : array[16+1, ImWchar]
...
proc igCaptureKeyboardFromApp*(capture: bool = true): void {.imgui_lib, importc: "igCaptureKeyboardFromApp".}
...
proc igSetScrollHere*(center_y_ratio: float32 = 0.5f): void {.imgui_lib, importc: "igSetScrollHere".}
...
proc igSetScrollFromPosY*(pos_y: float32, center_y_ratio: float32 = 0.5f): void {.imgui_lib, importc: "igSetScrollFromPosY".}
proc igInputInt2*(label: cstring, v: ptr int, extra_flags: ImGuiInputTextFlags = 0): bool {.imgui_lib, importc: "igInputInt2".}
...
proc igInputInt4*(label: cstring, v: ptr int, extra_flags: ImGuiInputTextFlags = 0): bool {.imgui_lib, importc: "igInputInt4".}
...
proc renderText*(self: ptr ImFont, draw_list: ptr ImDrawList, size: float32, pos: ImVec2, col: ImU32, clip_rect: ImVec4, text_begin: cstring, text_end: cstring, wrap_width: float32 = 0.0f, cpu_fine_clip: bool = false): void {.imgui_lib, importc: "ImFont_RenderText", varargs.}
...
proc popClipRect*(self: ptr ImDrawList): void {.imgui_lib, importc: "ImDrawList_PopClipRect", varargs.}
proc findGlyphNoFallback*(self: ptr ImFont, c: ImWchar): ptr ImFontGlyph {.imgui_lib, importc: "ImFont_FindGlyphNoFallback", varargs.}
...
proc calcWordWrapPositionA*(self: ptr ImFont, scale: float32, text: cstring, text_end: cstring, wrap_width: float32): cstring {.imgui_lib, importc: "ImFont_CalcWordWrapPositionA", varargs.}
proc calcTextSizeA*(self: ptr ImFont, size: float32, max_width: float32, wrap_width: float32, text_begin: cstring, text_end: cstring = nil, remaining: ptr ptr char = nil): ImVec2 {.imgui_lib, importc: "ImFont_CalcTextSizeA", varargs.}
proc glyphRangesBuilder_SetBit*(self: ptr GlyphRangesBuilder, n: int32): void {.imgui_lib, importc: "GlyphRangesBuilder_SetBit", varargs.}
proc isLoaded*(self: ptr ImFont): bool {.imgui_lib, importc: "ImFont_IsLoaded", varargs.}
proc getCharAdvance*(self: ptr ImFont, c: ImWchar): float32 {.imgui_lib, importc: "ImFont_GetCharAdvance", varargs.}
...
proc setFallbackChar*(self: ptr ImFont, c: ImWchar): void {.imgui_lib, importc: "ImFont_SetFallbackChar", varargs.}
...
proc renderChar*(self: ptr ImFont, draw_list: ptr ImDrawList, size: float32, pos: ImVec2, col: ImU32, c: uint16): void {.imgui_lib, importc: "ImFont_RenderChar", varargs.}
proc igRadioButton*(label: cstring, active: bool): bool {.imgui_lib, importc: "igRadioButton", varargs.}
proc pushClipRect*(self: ptr ImDrawList, clip_rect_min: ImVec2, clip_rect_max: ImVec2, intersect_with_current_clip_rect: bool = false): void {.imgui_lib, importc: "ImDrawList_PushClipRect", varargs.}
proc findGlyph*(self: ptr ImFont, c: ImWchar): ptr ImFontGlyph {.imgui_lib, importc: "ImFont_FindGlyph", varargs.}
...
proc addFont*(self: ptr ImFontAtlas, font_cfg: ptr ImFontConfig): ptr ImFont {.imgui_lib, importc: "ImFontAtlas_AddFont", varargs.}
proc pathBezierCurveTo*(self: ptr ImDrawList, p1: ImVec2, p2: ImVec2, p3: ImVec2, num_segments: int32 = 0): void {.imgui_lib, importc: "ImDrawList_PathBezierCurveTo", varargs.}
proc clear*(self: ptr ImGuiPayload): void {.imgui_lib, importc: "ImGuiPayload_Clear", varargs.}
...
proc igInputFloat*(label: cstring, v: ptr float32, step: float32 = 0.0f, step_fast: float32 = 0.0f, format: cstring = "%.3f", extra_flags: ImGuiInputTextFlags = 0): bool {.imgui_lib, importc: "igInputFloat", varargs.}
proc newImFont*(): void {.imgui_lib, importc: "ImFont_ImFont".}
proc setFloat*(self: ptr ImGuiStorage, key: ImGuiID, val: float32): void {.imgui_lib, importc: "ImGuiStorage_SetFloat", varargs.}
...
proc calcCustomRectUV*(self: ptr ImFontAtlas, rect: ptr CustomRect, out_uv_min: ptr ImVec2, out_uv_max: ptr ImVec2): void {.imgui_lib, importc: "ImFontAtlas_CalcCustomRectUV", varargs.}
proc igTextWrappedV*(fmt: cstring): void {.imgui_lib, importc: "igTextWrappedV", varargs.}
proc getCustomRectByIndex*(self: ptr ImFontAtlas, index: int32): ptr CustomRect {.imgui_lib, importc: "ImFontAtlas_GetCustomRectByIndex", varargs.}
proc glyphRangesBuilder_AddText*(self: ptr GlyphRangesBuilder, text: cstring, text_end: cstring = nil): void {.imgui_lib, importc: "GlyphRangesBuilder_AddText", varargs.}
proc updateTextureID*(self: ptr ImDrawList): void {.imgui_lib, importc: "ImDrawList_UpdateTextureID", varargs.}
proc igSetNextWindowSize*(size: ImVec2, cond: ImGuiCond = 0): void {.imgui_lib, importc: "igSetNextWindowSize", varargs.}
proc addCustomRectRegular*(self: ptr ImFontAtlas, id: uint32, width: int32, height: int32): int32 {.imgui_lib, importc: "ImFontAtlas_AddCustomRectRegular", varargs.}
...
proc customRect_IsPacked*(self: ptr CustomRect): bool {.imgui_lib, importc: "CustomRect_IsPacked", varargs.}
...
proc isBuilt*(self: ptr ImFontAtlas): bool {.imgui_lib, importc: "ImFontAtlas_IsBuilt", varargs.}
proc newImVec2*(): void {.imgui_lib, importc: "ImVec2_ImVec2".}
proc newImGuiPayload*(): void {.imgui_lib, importc: "ImGuiPayload_ImGuiPayload".}
proc clear*(self: ptr ImDrawList): void {.imgui_lib, importc: "ImDrawList_Clear", varargs.}
proc glyphRangesBuilder_AddRanges*(self: ptr GlyphRangesBuilder, ranges: ptr ImWchar): void {.imgui_lib, importc: "GlyphRangesBuilder_AddRanges", varargs.}
proc igGetFrameCount*(): int32 {.imgui_lib, importc: "igGetFrameCount".}
proc getDebugName*(self: ptr ImFont): cstring {.imgui_lib, importc: "ImFont_GetDebugName", varargs.}
proc igListBoxFooter*(): void {.imgui_lib, importc: "igListBoxFooter".}
proc igPopClipRect*(): void {.imgui_lib, importc: "igPopClipRect".}
proc addBezierCurve*(self: ptr ImDrawList, pos0: ImVec2, cp0: ImVec2, cp1: ImVec2, pos1: ImVec2, col: ImU32, thickness: float32, num_segments: int32 = 0): void {.imgui_lib, importc: "ImDrawList_AddBezierCurve", varargs.}
...
proc getGlyphRangesThai*(self: ptr ImFontAtlas): ptr ImWchar {.imgui_lib, importc: "ImFontAtlas_GetGlyphRangesThai", varargs.}
proc igCheckboxFlags*(label: cstring, flags: ptr uint32, flags_value: uint32): bool {.imgui_lib, importc: "igCheckboxFlags", varargs.}
proc getGlyphRangesCyrillic*(self: ptr ImFontAtlas): ptr ImWchar {.imgui_lib, importc: "ImFontAtlas_GetGlyphRangesCyrillic", varargs.}
proc igIsWindowHovered*(flags: ImGuiHoveredFlags = 0): bool {.imgui_lib, importc: "igIsWindowHovered", varargs.}
proc getGlyphRangesChineseSimplifiedCommon*(self: ptr ImFontAtlas): ptr ImWchar {.imgui_lib, importc: "ImFontAtlas_GetGlyphRangesChineseSimplifiedCommon", varargs.}
...
proc getGlyphRangesChineseFull*(self: ptr ImFontAtlas): ptr ImWchar {.imgui_lib, importc: "ImFontAtlas_GetGlyphRangesChineseFull", varargs.}
...
proc pushTextureID*(self: ptr ImDrawList, texture_id: ImTextureID): void {.imgui_lib, importc: "ImDrawList_PushTextureID", varargs.}
proc igTreeAdvanceToLabelPos*(): void {.imgui_lib, importc: "igTreeAdvanceToLabelPos".}
proc deleteChars*(self: ptr ImGuiInputTextCallbackData, pos: int32, bytes_count: int32): void {.imgui_lib, importc: "ImGuiInputTextCallbackData_DeleteChars", varargs.}
...
proc getGlyphRangesDefault*(self: ptr ImFontAtlas): ptr ImWchar {.imgui_lib, importc: "ImFontAtlas_GetGlyphRangesDefault", varargs.}
proc igIsAnyItemActive*(): bool {.imgui_lib, importc: "igIsAnyItemActive".}
proc setTexID*(self: ptr ImFontAtlas, id: ImTextureID): void {.imgui_lib, importc: "ImFontAtlas_SetTexID", varargs.}
...
proc clearTexData*(self: ptr ImFontAtlas): void {.imgui_lib, importc: "ImFontAtlas_ClearTexData", varargs.}
...
proc isPreview*(self: ptr ImGuiPayload): bool {.imgui_lib, importc: "ImGuiPayload_IsPreview", varargs.}
proc igSpacing*(): void {.imgui_lib, importc: "igSpacing".}
proc clear*(self: ptr ImFontAtlas): void {.imgui_lib, importc: "ImFontAtlas_Clear", varargs.}
proc igIsAnyItemFocused*(): bool {.imgui_lib, importc: "igIsAnyItemFocused".}
proc addRectFilled*(self: ptr ImDrawList, a: ImVec2, b: ImVec2, col: ImU32, rounding: float32 = 0.0f, rounding_corners_flags: int32 = ImDrawCornerFlags_All): void {.imgui_lib, importc: "ImDrawList_AddRectFilled", varargs.}
proc addFontFromMemoryCompressedTTF*(self: ptr ImFontAtlas, compressed_font_data: pointer, compressed_font_size: int32, size_pixels: float32, font_cfg: ptr ImFontConfig = nil, glyph_ranges: ptr ImWchar = nil): ptr ImFont {.imgui_lib, importc: "ImFontAtlas_AddFontFromMemoryCompressedTTF", varargs.}
...
proc addDrawCmd*(self: ptr ImDrawList): void {.imgui_lib, importc: "ImDrawList_AddDrawCmd", varargs.}
proc igIsItemClicked*(mouse_button: int32 = 0): bool {.imgui_lib, importc: "igIsItemClicked", varargs.}
proc addFontFromMemoryTTF*(self: ptr ImFontAtlas, font_data: pointer, font_size: int32, size_pixels: float32, font_cfg: ptr ImFontConfig = nil, glyph_ranges: ptr ImWchar = nil): ptr ImFont {.imgui_lib, importc: "ImFontAtlas_AddFontFromMemoryTTF", varargs.}
proc addFontFromFileTTF*(self: ptr ImFontAtlas, filename: cstring, size_pixels: float32, font_cfg: ptr ImFontConfig = nil, glyph_ranges: ptr ImWchar = nil): ptr ImFont {.imgui_lib, importc: "ImFontAtlas_AddFontFromFileTTF", varargs.}
proc igProgressBar*(fraction: float32, size_arg: ImVec2, overlay: cstring = nil): void {.imgui_lib, importc: "igProgressBar", varargs.}
proc addFontDefault*(self: ptr ImFontAtlas, font_cfg: ptr ImFontConfig = nil): ptr ImFont {.imgui_lib, importc: "ImFontAtlas_AddFontDefault", varargs.}
...
proc buildLookupTable*(self: ptr ImFont): void {.imgui_lib, importc: "ImFont_BuildLookupTable", varargs.}
...
proc getGlyphRangesJapanese*(self: ptr ImFontAtlas): ptr ImWchar {.imgui_lib, importc: "ImFontAtlas_GetGlyphRangesJapanese", varargs.}
...
proc scaleClipRects*(self: ptr ImDrawData, sc: ImVec2): void {.imgui_lib, importc: "ImDrawData_ScaleClipRects", varargs.}
proc igGetItemRectMin*(): ImVec2 {.imgui_lib, importc: "igGetItemRectMin".}
proc deIndexAllBuffers*(self: ptr ImDrawData): void {.imgui_lib, importc: "ImDrawData_DeIndexAllBuffers", varargs.}
proc igLogText*(fmt: cstring): void {.imgui_lib, importc: "igLogText", varargs.}
proc clear*(self: ptr ImDrawData): void {.imgui_lib, importc: "ImDrawData_Clear", varargs.}
proc getVoidPtr*(self: ptr ImGuiStorage, key: ImGuiID): pointer {.imgui_lib, importc: "ImGuiStorage_GetVoidPtr", varargs.}
proc igTextWrapped*(fmt: cstring): void {.imgui_lib, importc: "igTextWrapped", varargs.}
proc updateClipRect*(self: ptr ImDrawList): void {.imgui_lib, importc: "ImDrawList_UpdateClipRect", varargs.}
proc primVtx*(self: ptr ImDrawList, pos: ImVec2, uv: ImVec2, col: ImU32): void {.imgui_lib, importc: "ImDrawList_PrimVtx", varargs.}
...
proc primRect*(self: ptr ImDrawList, a: ImVec2, b: ImVec2, col: ImU32): void {.imgui_lib, importc: "ImDrawList_PrimRect", varargs.}
proc destroy*(self: ptr ImGuiListClipper): void {.imgui_lib, importc: "ImGuiListClipper_destroy", varargs.}
proc clearFreeMemory*(self: ptr ImDrawList): void {.imgui_lib, importc: "ImDrawList_ClearFreeMemory", varargs.}
...
proc glyphRangesBuilder_BuildRanges*(self: ptr GlyphRangesBuilder, out_ranges: ptr ImVector_ImWchar): void {.imgui_lib, importc: "GlyphRangesBuilder_BuildRanges", varargs.}
proc igSetTooltipV*(fmt: cstring): void {.imgui_lib, importc: "igSetTooltipV", varargs.}
proc cloneOutput*(self: ptr ImDrawList): ptr ImDrawList {.imgui_lib, importc: "ImDrawList_CloneOutput", varargs.}
...
proc addRect*(self: ptr ImDrawList, a: ImVec2, b: ImVec2, col: ImU32, rounding: float32 = 0.0f, rounding_corners_flags: int32 = ImDrawCornerFlags_All, thickness: float32 = 1.0f): void {.imgui_lib, importc: "ImDrawList_AddRect", varargs.}
...
proc addCallback*(self: ptr ImDrawList, callback: ImDrawCallback, callback_data: pointer): void {.imgui_lib, importc: "ImDrawList_AddCallback", varargs.}
...
proc pathRect*(self: ptr ImDrawList, rect_min: ImVec2, rect_max: ImVec2, rounding: float32 = 0.0f, rounding_corners_flags: int32 = ImDrawCornerFlags_All): void {.imgui_lib, importc: "ImDrawList_PathRect", varargs.}
...
proc pathArcToFast*(self: ptr ImDrawList, centre: ImVec2, radius: float32, a_min_of_12: int32, a_max_of_12: int32): void {.imgui_lib, importc: "ImDrawList_PathArcToFast", varargs.}
...
proc glyphRangesBuilder_GetBit*(self: ptr GlyphRangesBuilder, n: int32): bool {.imgui_lib, importc: "GlyphRangesBuilder_GetBit", varargs.}
...
proc pathStroke*(self: ptr ImDrawList, col: ImU32, closed: bool, thickness: float32 = 1.0f): void {.imgui_lib, importc: "ImDrawList_PathStroke", varargs.}
proc pathFillConvex*(self: ptr ImDrawList, col: ImU32): void {.imgui_lib, importc: "ImDrawList_PathFillConvex", varargs.}
proc pathLineToMergeDuplicate*(self: ptr ImDrawList, pos: ImVec2): void {.imgui_lib, importc: "ImDrawList_PathLineToMergeDuplicate", varargs.}
...
proc getTexDataAsAlpha8*(self: ptr ImFontAtlas, out_pixels: ptr ptr char, out_width: ptr int32, out_height: ptr int32, out_bytes_per_pixel: ptr int32 = nil): void {.imgui_lib, importc: "ImFontAtlas_GetTexDataAsAlpha8", varargs.}
...
proc pathArcTo*(self: ptr ImDrawList, centre: ImVec2, radius: float32, a_min: float32, a_max: float32, num_segments: int32 = 10): void {.imgui_lib, importc: "ImDrawList_PathArcTo", varargs.}
proc addConvexPolyFilled*(self: ptr ImDrawList, points: ptr ImVec2, num_points: int32, col: ImU32): void {.imgui_lib, importc: "ImDrawList_AddConvexPolyFilled", varargs.}
...
proc addImageQuad*(self: ptr ImDrawList, user_texture_id: ImTextureID, a: ImVec2, b: ImVec2, c: ImVec2, d: ImVec2, uv_a: ImVec2, uv_b: ImVec2, uv_c: ImVec2, uv_d: ImVec2, col: ImU32 = 0xFFFFFFF): void {.imgui_lib, importc: "ImDrawList_AddImageQuad", varargs.}
proc igSetNextWindowFocus*(): void {.imgui_lib, importc: "igSetNextWindowFocus".}
proc igSameLine*(pos_x: float32 = 0.0f, spacing_w: float32 = -1.0f): void {.imgui_lib, importc: "igSameLine", varargs.}
...
proc addImage*(self: ptr ImDrawList, user_texture_id: ImTextureID, a: ImVec2, b: ImVec2, uv_a: ImVec2, uv_b: ImVec2, col: ImU32 = 0xFFFFFFF): void {.imgui_lib, importc: "ImDrawList_AddImage", varargs.}
proc addInputCharactersUTF8*(self: ptr ImGuiIO, utf8_chars: cstring): void {.imgui_lib, importc: "ImGuiIO_AddInputCharactersUTF8", varargs.}
proc addText*(self: ptr ImDrawList, pos: ImVec2, col: ImU32, text_begin: cstring, text_end: cstring = nil): void {.imgui_lib, importc: "ImDrawList_AddText", varargs.}
proc addCircleFilled*(self: ptr ImDrawList, centre: ImVec2, radius: float32, col: ImU32, num_segments: int32 = 12): void {.imgui_lib, importc: "ImDrawList_AddCircleFilled", varargs.}
proc igInputFloat2*(label: cstring, v: ptr float, format: cstring = "%.3f", extra_flags: ImGuiInputTextFlags = 0): bool {.imgui_lib, importc: "igInputFloat2", varargs.}
...
proc addCircle*(self: ptr ImDrawList, centre: ImVec2, radius: float32, col: ImU32, num_segments: int32 = 12, thickness: float32 = 1.0f): void {.imgui_lib, importc: "ImDrawList_AddCircle", varargs.}
proc addTriangleFilled*(self: ptr ImDrawList, a: ImVec2, b: ImVec2, c: ImVec2, col: ImU32): void {.imgui_lib, importc: "ImDrawList_AddTriangleFilled", varargs.}
proc addTriangle*(self: ptr ImDrawList, a: ImVec2, b: ImVec2, c: ImVec2, col: ImU32, thickness: float32 = 1.0f): void {.imgui_lib, importc: "ImDrawList_AddTriangle", varargs.}
proc addQuadFilled*(self: ptr ImDrawList, a: ImVec2, b: ImVec2, c: ImVec2, d: ImVec2, col: ImU32): void {.imgui_lib, importc: "ImDrawList_AddQuadFilled", varargs.}
proc igGetFontSize*(): float32 {.imgui_lib, importc: "igGetFontSize".}
proc igInputDouble*(label: cstring, v: ptr float64, step: float64 = 0.0f, step_fast: float64 = 0.0f, format: cstring = "%.6f", extra_flags: ImGuiInputTextFlags = 0): bool {.imgui_lib, importc: "igInputDouble", varargs.}
proc primReserve*(self: ptr ImDrawList, idx_count: int32, vtx_count: int32): void {.imgui_lib, importc: "ImDrawList_PrimReserve", varargs.}
proc addRectFilledMultiColor*(self: ptr ImDrawList, a: ImVec2, b: ImVec2, col_upr_left: ImU32, col_upr_right: ImU32, col_bot_right: ImU32, col_bot_left: ImU32): void {.imgui_lib, importc: "ImDrawList_AddRectFilledMultiColor", varargs.}
proc igEndPopup*(): void {.imgui_lib, importc: "igEndPopup".}
proc clearInputData*(self: ptr ImFontAtlas): void {.imgui_lib, importc: "ImFontAtlas_ClearInputData", varargs.}
proc addLine*(self: ptr ImDrawList, a: ImVec2, b: ImVec2, col: ImU32, thickness: float32 = 1.0f): void {.imgui_lib, importc: "ImDrawList_AddLine", varargs.}
...
proc getClipRectMin*(self: ptr ImDrawList): ImVec2 {.imgui_lib, importc: "ImDrawList_GetClipRectMin", varargs.}
proc popTextureID*(self: ptr ImDrawList): void {.imgui_lib, importc: "ImDrawList_PopTextureID", varargs.}
proc igInputFloat4*(label: cstring, v: ptr float, format: cstring = "%.3f", extra_flags: ImGuiInputTextFlags = 0): bool {.imgui_lib, importc: "igInputFloat4", varargs.}
proc igSetCursorPosY*(y: float32): void {.imgui_lib, importc: "igSetCursorPosY", varargs.}
...
proc newImDrawList*(shared_data: ptr ImDrawListSharedData): void {.imgui_lib, importc: "ImDrawList_ImDrawList", varargs.}
proc newImDrawCmd*(): void {.imgui_lib, importc: "ImDrawCmd_ImDrawCmd".}
proc igEnd*(self: ptr ImGuiListClipper): void {.imgui_lib, importc: "ImGuiListClipper_End", varargs.}
...
proc begin*(self: ptr ImGuiListClipper, items_count: int32, items_height: float32 = -1.0f): void {.imgui_lib, importc: "ImGuiListClipper_Begin", varargs.}
proc igText*(fmt: cstring): void {.imgui_lib, importc: "igText", varargs.}
proc step*(self: ptr ImGuiListClipper): bool {.imgui_lib, importc: "ImGuiListClipper_Step", varargs.}
proc igGetTextLineHeightWithSpacing*(): float32 {.imgui_lib, importc: "igGetTextLineHeightWithSpacing".}
proc getFloatRef*(self: ptr ImGuiStorage, key: ImGuiID, default_val: float32 = 0.0f): ptr float32 {.imgui_lib, importc: "ImGuiStorage_GetFloatRef", varargs.}
proc igEndTooltip*(): void {.imgui_lib, importc: "igEndTooltip".}
proc newImGuiListClipper*(items_count: int32 = -1, items_height: float32 = -1.0f): void {.imgui_lib, importc: "ImGuiListClipper_ImGuiListClipper", varargs.}
...
proc clearInputCharacters*(self: ptr ImGuiIO): void {.imgui_lib, importc: "ImGuiIO_ClearInputCharacters", varargs.}
...
proc isDataType*(self: ptr ImGuiPayload, `type`: cstring): bool {.imgui_lib, importc: "ImGuiPayload_IsDataType", varargs.}
...
proc hasSelection*(self: ptr ImGuiInputTextCallbackData): bool {.imgui_lib, importc: "ImGuiInputTextCallbackData_HasSelection", varargs.}
proc insertChars*(self: ptr ImGuiInputTextCallbackData, pos: int32, text: cstring, text_end: cstring = nil): void {.imgui_lib, importc: "ImGuiInputTextCallbackData_InsertChars", varargs.}
proc getMouseCursorTexData*(self: ptr ImFontAtlas, cursor: ImGuiMouseCursor, out_offset: ptr ImVec2, out_size: ptr ImVec2, out_uv_border: ptr ImVec2, out_uv_fill: ptr ImVec2): bool {.imgui_lib, importc: "ImFontAtlas_GetMouseCursorTexData", varargs.}
...
proc setAllInt*(self: ptr ImGuiStorage, val: int32): void {.imgui_lib, importc: "ImGuiStorage_SetAllInt", varargs.}
proc destroy*(self: ptr ImFontConfig): void {.imgui_lib, importc: "ImFontConfig_destroy", varargs.}
...
proc getBoolRef*(self: ptr ImGuiStorage, key: ImGuiID, default_val: bool = false): ptr bool {.imgui_lib, importc: "ImGuiStorage_GetBoolRef", varargs.}
...
proc getIntRef*(self: ptr ImGuiStorage, key: ImGuiID, default_val: int32 = 0): ptr int32 {.imgui_lib, importc: "ImGuiStorage_GetIntRef", varargs.}
...
proc setVoidPtr*(self: ptr ImGuiStorage, key: ImGuiID, val: pointer): void {.imgui_lib, importc: "ImGuiStorage_SetVoidPtr", varargs.}
proc igEndDragDropSource*(): void {.imgui_lib, importc: "igEndDragDropSource".}
proc buildSortByKey*(self: ptr ImGuiStorage): void {.imgui_lib, importc: "ImGuiStorage_BuildSortByKey", varargs.}
proc getFloat*(self: ptr ImGuiStorage, key: ImGuiID, default_val: float32 = 0.0f): float32 {.imgui_lib, importc: "ImGuiStorage_GetFloat", varargs.}
proc setBool*(self: ptr ImGuiStorage, key: ImGuiID, val: bool): void {.imgui_lib, importc: "ImGuiStorage_SetBool", varargs.}
proc getBool*(self: ptr ImGuiStorage, key: ImGuiID, default_val: bool = false): bool {.imgui_lib, importc: "ImGuiStorage_GetBool", varargs.}
...
proc setInt*(self: ptr ImGuiStorage, key: ImGuiID, val: int32): void {.imgui_lib, importc: "ImGuiStorage_SetInt", varargs.}
...
proc clear*(self: ptr ImGuiStorage): void {.imgui_lib, importc: "ImGuiStorage_Clear", varargs.}
...
proc primWriteVtx*(self: ptr ImDrawList, pos: ImVec2, uv: ImVec2, col: ImU32): void {.imgui_lib, importc: "ImDrawList_PrimWriteVtx", varargs.}
...
proc igInputInt3*(label: cstring, v: ptr int, extra_flags: ImGuiInputTextFlags = 0): bool {.imgui_lib, importc: "igInputInt3", varargs.}
...
proc igInputInt*(label: cstring, v: ptr int32, step: int32 = 1, step_fast: int32 = 100, extra_flags: ImGuiInputTextFlags = 0): bool {.imgui_lib, importc: "igInputInt", varargs.}
...
proc getClipRectMax*(self: ptr ImDrawList): ImVec2 {.imgui_lib, importc: "ImDrawList_GetClipRectMax", varargs.}
...
proc isDelivery*(self: ptr ImGuiPayload): bool {.imgui_lib, importc: "ImGuiPayload_IsDelivery", varargs.}
proc addInputCharacter*(self: ptr ImGuiIO, c: ImWchar): void {.imgui_lib, importc: "ImGuiIO_AddInputCharacter", varargs.}
proc addImageRounded*(self: ptr ImDrawList, user_texture_id: ImTextureID, a: ImVec2, b: ImVec2, uv_a: ImVec2, uv_b: ImVec2, col: ImU32, rounding: float32, rounding_corners: int32 = ImDrawCornerFlags_All): void {.imgui_lib, importc: "ImDrawList_AddImageRounded", varargs.}
...
proc clearOutputData*(self: ptr ImFont): void {.imgui_lib, importc: "ImFont_ClearOutputData", varargs.}
proc destroy*(self: ptr ImColor): void {.imgui_lib, importc: "ImColor_destroy", varargs.}
proc primQuadUV*(self: ptr ImDrawList, a: ImVec2, b: ImVec2, c: ImVec2, d: ImVec2, uv_a: ImVec2, uv_b: ImVec2, uv_c: ImVec2, uv_d: ImVec2, col: ImU32): void {.imgui_lib, importc: "ImDrawList_PrimQuadUV", varargs.}
proc igEndDragDropTarget*(): void {.imgui_lib, importc: "igEndDragDropTarget".}
proc getGlyphRangesKorean*(self: ptr ImFontAtlas): ptr ImWchar {.imgui_lib, importc: "ImFontAtlas_GetGlyphRangesKorean", varargs.}
...
proc getTexDataAsRGBA32*(self: ptr ImFontAtlas, out_pixels: ptr ptr char, out_width: ptr int32, out_height: ptr int32, out_bytes_per_pixel: ptr int32 = nil): void {.imgui_lib, importc: "ImFontAtlas_GetTexDataAsRGBA32", varargs.}
...
proc glyphRangesBuilder_AddChar*(self: ptr GlyphRangesBuilder, c: ImWchar): void {.imgui_lib, importc: "GlyphRangesBuilder_AddChar", varargs.}
...
proc pathClear*(self: ptr ImDrawList): void {.imgui_lib, importc: "ImDrawList_PathClear", varargs.}
...
proc glyphRangesBuilder_destroy*(self: ptr GlyphRangesBuilder): void {.imgui_lib, importc: "GlyphRangesBuilder_destroy", varargs.}
...
proc primWriteIdx*(self: ptr ImDrawList, idx: ImDrawIdx): void {.imgui_lib, importc: "ImDrawList_PrimWriteIdx", varargs.}
proc scaleAllSizes*(self: ptr ImGuiStyle, scale_factor: float32): void {.imgui_lib, importc: "ImGuiStyle_ScaleAllSizes", varargs.}
...
proc igInputScalar*(label: cstring, data_type: ImGuiDataType, v: pointer, step: pointer = nil, step_fast: pointer = nil, format: cstring = nil, extra_flags: ImGuiInputTextFlags = 0): bool {.imgui_lib, importc: "igInputScalar", varargs.}
proc pushClipRectFullScreen*(self: ptr ImDrawList): void {.imgui_lib, importc: "ImDrawList_PushClipRectFullScreen", varargs.}
...
proc channelsMerge*(self: ptr ImDrawList): void {.imgui_lib, importc: "ImDrawList_ChannelsMerge", varargs.}
...
proc igSetCursorPosX*(x: float32): void {.imgui_lib, importc: "igSetCursorPosX", varargs.}
...
proc addCustomRectFontGlyph*(self: ptr ImFontAtlas, font: ptr ImFont, id: ImWchar, width: int32, height: int32, advance_x: float32, offset: ImVec2): int32 {.imgui_lib, importc: "ImFontAtlas_AddCustomRectFontGlyph", varargs.}
...
proc igSliderAngle*(label: cstring, v_rad: ptr float32, v_degrees_min: float32 = -360.0f, v_degrees_max: float32 = +360.0f): bool {.imgui_lib, importc: "igSliderAngle", varargs.}
...
proc igPushTextWrapPos*(wrap_pos_x: float32 = 0.0f): void {.imgui_lib, importc: "igPushTextWrapPos", varargs.}
proc getInt*(self: ptr ImGuiStorage, key: ImGuiID, default_val: int32 = 0): int32 {.imgui_lib, importc: "ImGuiStorage_GetInt", varargs.}
...
proc hSV*(self: ptr ImColor, h: float32, s: float32, v: float32, a: float32 = 1.0f): ImColor {.imgui_lib, importc: "ImColor_HSV", varargs.}
proc pathLineTo*(self: ptr ImDrawList, pos: ImVec2): void {.imgui_lib, importc: "ImDrawList_PathLineTo", varargs.}
...
proc destroy*(self: ptr ImFont): void {.imgui_lib, importc: "ImFont_destroy", varargs.}
...
proc primRectUV*(self: ptr ImDrawList, a: ImVec2, b: ImVec2, uv_a: ImVec2, uv_b: ImVec2, col: ImU32): void {.imgui_lib, importc: "ImDrawList_PrimRectUV", varargs.}
...
proc igCaptureMouseFromApp*(capture: bool = true): void {.imgui_lib, importc: "igCaptureMouseFromApp", varargs.}
...
proc destroy*(self: ptr ImDrawData): void {.imgui_lib, importc: "ImDrawData_destroy", varargs.}
...
proc destroy*(self: ptr ImGuiOnceUponAFrame): void {.imgui_lib, importc: "ImGuiOnceUponAFrame_destroy", varargs.}
proc igInputScalarN*(label: cstring, data_type: ImGuiDataType, v: pointer, components: int32, step: pointer = nil, step_fast: pointer = nil, format: cstring = nil, extra_flags: ImGuiInputTextFlags = 0): bool {.imgui_lib, importc: "igInputScalarN", varargs.}
...
proc igInputFloat3*(label: cstring, v: ptr float, format: cstring = "%.3f", extra_flags: ImGuiInputTextFlags = 0): bool {.imgui_lib, importc: "igInputFloat3", varargs.}
