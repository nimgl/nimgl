...
const
  ...
  VK_REMAINING_MIP_LEVELS* = (not 0'u32) # ~0U
  VK_REMAINING_ARRAY_LAYERS* = (not 0'u32) # ~0U
  VK_WHOLE_SIZE* = (not 0'u64) # ~0ULL
  VK_ATTACHMENT_UNUSED* = (not 0'u32) # ~0U
  VK_TRUE* = 1
  VK_FALSE* = 0
  VK_QUEUE_FAMILY_IGNORED* = (not 0'u32) # ~0U
  VK_QUEUE_FAMILY_EXTERNAL* = (not 0'u32) - 1 # ~0U-1
  VK_QUEUE_FAMILY_EXTERNAL_KHR* = VK_QUEUE_FAMILY_EXTERNAL
  VK_QUEUE_FAMILY_FOREIGN_EXT* = (not 0'u32) - 2 # ~0U-2
  VK_SUBPASS_EXTERNAL* = (not 0'u32) # ~0U
  VK_MAX_DEVICE_GROUP_SIZE* = 32
  VK_MAX_DEVICE_GROUP_SIZE_KHR* = VK_MAX_DEVICE_GROUP_SIZE
  VK_MAX_DRIVER_NAME_SIZE_KHR* = 256
  VK_MAX_DRIVER_INFO_SIZE_KHR* = 256
  VK_SHADER_UNUSED_NV* = (not 0'u32) # ~0U
